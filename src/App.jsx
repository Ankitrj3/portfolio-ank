          ...
          <div className="landing overflow-hidden relative w-full h-screen bg-black">
            ...
            <div className="imagesdiv relative overflow-hidden w-full h-screen">
              ...
              <div className="text text-white flex flex-col gap-3 absolute top-20 left-1/2 -translate-x-1/2 scale-[1.4] rotate-[-10deg]">
                <h1 className="text-[12rem] leading-none -ml-40">ankit</h1>
                <h1 className="text-[12rem] leading-none ml-20">ranjan</h1>
                <h1 className="text-[12rem] leading-none -ml-40">portfolio</h1>
              </div>
              <img
                className="absolute character bottom-0 left-1/2 -translate-x-1/2 scale-[1.5] rotate-[-20deg]"
                src="./ank.png"
                alt=""
              />
            </div>
          ...
          <div className="w-full h-screen flex items-center justify-center bg-black">
            <div className="cntnr flex text-white w-full h-[80%] ">
              ...
              <div className="rg w-[30%] py-30">
                <h1 className="text-8xl">Ankit Ranjan</h1>
                <h1 className="text-8xl">Full Stack Developer</h1>
                <div className="mt-10 text-xl font-[Helvetica_Now_Display]">
                ...
                <div className="mt-6 text-lg font-[Helvetica_Now_Display]">
                  <h3 className="text-2xl text-yellow-500 mb-3">Skills</h3>
                ...
                <div className="mt-6 text-lg font-[Helvetica_Now_Display]">
                  <h3 className="text-2xl text-yellow-500 mb-3">Education</h3>
